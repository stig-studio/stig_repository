...
namespace Exam {
    ...
    class vip_restaurant: Restaurant {

        public vip_restaurant( string name, string address, string phone ): base( name, address, phone ) { }
                ...
                if (choose == 1) {
                    ...
                    while (true) {
                        ...
                        if (ch == 1)
                        {
                            ...
                            if (menu == 1) s.add_dish(this.morning_menu[dish - 1], quantity_dish);
                            else if (menu == 2) s.add_dish(this.day_menu[dish - 1], quantity_dish);
                            else if (menu == 3) s.add_dish(this.evening_menu[dish - 1], quantity_dish);
        ...
        public override void print_menu() {
            ...
            Console.WriteLine("-----------------------------------------------------------\n");
            Console.WriteLine("Дневное меню");
            Console.WriteLine("-----------------------------------------------------------");
            ...
            Console.WriteLine("-----------------------------------------------------------\n");
            Console.WriteLine("Вечернее меню");
            Console.WriteLine("-----------------------------------------------------------");
